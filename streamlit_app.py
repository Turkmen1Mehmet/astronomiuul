...
from datasetOrbit2 import datasetOrbit
...
def get_data(processed, sample_size=None):
    ...
    data_completed = pd.read_csv('asteroid_completed.csv')
...
def get_sidebar_image(page):
    if page == "Hosgeldiniz":
        ...
        return "Images/diameter-predict.jpeg"
    elif page == "Gunes ve Asteroidler":
        return "Images/sun-and-asteroid.jpeg"
    elif page == "RFM-ALTV":
        return "Images/CLTV.jpeg"
